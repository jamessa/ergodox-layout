...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    TT(1),          KC_LSHIFT,      KC_LCTRL,       KC_LALT,        MO(1),                                                                                                          KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       TT(2),
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_BTN2,     KC_MS_UP,       KC_MS_BTN1,     KC_TRANSPARENT, TO(0),                                          TO(0),          KC_AUDIO_VOL_UP,KC_HOME,        KC_UP,          KC_PGUP,        KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_EXLM,        KC_AT,          KC_LCBR,        KC_RCBR,        KC_PIPE,        TO(0),                                          TO(0),          KC_KP_PLUS,     KC_7,           KC_8,           KC_9,           KC_KP_ASTERISK, KC_F12,
